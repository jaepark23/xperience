...
function Projects(props: {}) {
    ...
    return (
      ...
      <Swiper pagination={pagination} loop={true} autoplay = {{delay: 10000, disableOnInteraction: true }} slidesPerView = {1} navigation={true} modules={[Navigation,  Autoplay]} className="mySwiper">
              <SwiperSlide> <Project name = "Storelytics" img = {require("../../img/storelytics3.jpg")} creator = "test" points = {["iOS based app built using Python and React-Native", "Uses machine learning to detect peoples' faces going in and out of a store", "Tracks how many people come in and out of a store and at what time they come in and out"]}/> </SwiperSlide> 
